...
class Magician(Character):
    ...
    def __init__(self, name, max_hp, max_mp, attack, magic_attack, defense,
                 level):
    ...
    def _compute_magical_damage(self, other):
        return Character.compute_damage_output((self.level + self.magic_attack),
                                               self.spell.power, 1, 1, 1/8, (0.85, 1.0))
